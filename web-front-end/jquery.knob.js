...
(($) => {
    $.fn.knob = function (options) {
        ...
        $this.addClass("knob").mousedown(function (event) {
            $current = $(this);
            anchorX = event.screenX - ($current.data('knob-angle') || 0);
        ...
        $(document).mousemove(event => {
            ...
            if ($current) {
                ...
                let newAngle = mouse.x > center.x ? find_angle(top, center, mouse) : -find_angle(top, center, mouse);
